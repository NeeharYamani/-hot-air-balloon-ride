...
function draw() {
  ...
  if(keyDown(UP_ARROW)){
    ...
    if (balloon1.scale >0.1){ balloon1.scale = balloon1.scale-0.05;}
  }
  if(keyDown(DOWN_ARROW)){
    balloon1.y = balloon1.y+3;
    
    if (balloon1.scale <1){ balloon1.scale = balloon1.scale+0.05; }
  }
  if(keyDown(LEFT_ARROW)){
    balloon1.x = balloon1.x-3;
